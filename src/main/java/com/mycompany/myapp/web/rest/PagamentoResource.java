...
public class PagamentoResource {
        ...
        Optional<Pagamento> result = pagamentoRepository
            ...
            .map(existingPagamento -> {
                ...
                if (pagamento.getParcela() != null) {
                    existingPagamento.setParcela(pagamento.getParcela());
                }
    ...
    public List<Pagamento> getAllPagamentos(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
        log.debug("REST request to get all Pagamentos");
        return pagamentoRepository.findAllWithEagerRelationships();
    }
    ...
    public ResponseEntity<Pagamento> getPagamento(@PathVariable Long id) {
        ...
        Optional<Pagamento> pagamento = pagamentoRepository.findOneWithEagerRelationships(id);
