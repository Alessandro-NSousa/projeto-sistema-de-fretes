...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.Motorista}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Motorista> partialUpdateMotorista(
        ...
        Optional<Motorista> result = motoristaRepository
            ...
            .map(existingMotorista -> {
                ...
                if (motorista.getInscEstadual() != null) {
                    existingMotorista.setInscEstadual(motorista.getInscEstadual());
                }
                if (motorista.getCnpj() != null) {
                    existingMotorista.setCnpj(motorista.getCnpj());
                }
