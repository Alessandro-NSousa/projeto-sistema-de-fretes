...
import com.mycompany.myapp.domain.Viagem;
import com.mycompany.myapp.repository.ViagemRepository;
...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.Viagem}.
 */
@RestController
@RequestMapping("/api")
@Transactional
