...
import com.mycompany.myapp.domain.Frete;
import com.mycompany.myapp.repository.FreteRepository;
...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.Frete}.
 */
@RestController
@RequestMapping("/api")
@Transactional
