...
class ClienteResourceIT {
    ...
    void createCliente() throws Exception {
        ...
        assertThat(testCliente.getTelefoneAdicional()).isEqualTo(DEFAULT_TELEFONE_ADICIONAL);
        assertThat(testCliente.getCnh()).isEqualTo(DEFAULT_CNH);
    ...
    void putNewCliente() throws Exception {
        ...
        assertThat(testCliente.getTelefoneAdicional()).isEqualTo(UPDATED_TELEFONE_ADICIONAL);
        assertThat(testCliente.getCnh()).isEqualTo(UPDATED_CNH);
    ...
    void partialUpdateClienteWithPatch() throws Exception {
        ...
        partialUpdatedCliente.telefoneAdicional(UPDATED_TELEFONE_ADICIONAL);
